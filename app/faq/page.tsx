...
export const metadata: Metadata = { title: "Perguntas frequentes | No Ritmo", description: "Respostas para começar na dança de salão com mais segurança e clareza.", alternates: { canonical: "/faq" }, openGraph: { title: "Perguntas frequentes | No Ritmo", description: "Respostas para começar na dança de salão com mais segurança e clareza.", url: "/faq", images: ["/logo-fundo-claro.png"] } };
