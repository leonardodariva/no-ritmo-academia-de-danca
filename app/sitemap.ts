...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = ["/", "/sobre", "/aulas", "/aulas-particulares", "/modalidades", "/servicos", "/formacao", "/coreografias/casamentos", "/coreografias/debutantes", "/coreografias/eventos", "/coreografias/gincanas", "/professores", "/autores", "/horarios", "/galeria", "/faq", "/contato", "/eventos", "/projetos", "/conhecimento", "/artigos"];
