...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = ["/", "/sobre", "/aulas", "/aulas-particulares", "/modalidades", "/coreografias/casamentos", "/coreografias/debutantes", "/coreografias/eventos", "/coreografias/gincanas", "/professores", "/autores", "/horarios", "/galeria", "/faq", "/contato", "/eventos", "/conhecimento", "/artigos"];
