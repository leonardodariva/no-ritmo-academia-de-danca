...
<section className="home-classes home-services" id="produtos">
      ...
      <div className="home-services-grid home-services-extra">
        ...
        <article>
          ...
          <div><h3>CFP — Curso de Formação de Professores</h3><p>Formação completa para quem deseja ensinar dança com técnica, consciência e segurança.</p><Link href="/formacao/cfp" aria-label="Saiba mais sobre o CFP">Saiba mais sobre o serviço</Link></div>
        </article>
        <article>
