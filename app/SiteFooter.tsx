...
export default function SiteFooter() {
  return <footer className="v4-footer">
    <div className="v4-footer-intro"><Link href="/" aria-label="No Ritmo — página inicial"><Image src="/logo-fundo-escuro.png" width={1741} height={421} alt="No Ritmo Academia de Dança" unoptimized /></Link><hr /><p>Dança, conhecimento, movimento e encontros em Apucarana.</p></div>
