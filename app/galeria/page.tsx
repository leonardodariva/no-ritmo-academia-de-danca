...
export default function GaleriaPage() { return <SubpageShell kicker="A No Ritmo em movimento" title="Galeria" intro="Fotos e vídeos reais das aulas, professores, alunos, ensaios e do espaço serão organizados aqui após seleção e autorização." sections={[
