...
export const metadata: Metadata = { title: "Galeria | No Ritmo", description: "Explore os álbuns de aulas, festas e projetos da No Ritmo.", alternates: { canonical: "/galeria" }, openGraph: { title: "Galeria | No Ritmo", description: "Explore os álbuns de aulas, festas e projetos da No Ritmo.", url: "/galeria", images: ["/logo-fundo-claro.png"] } };
