...
export default function ProfessoresPage() { return <SubpageShell kicker="Quem faz a No Ritmo" title="Professores e equipe" intro="Este espaço receberá os nomes, fotografias, trajetórias e especialidades dos profissionais da academia." sections={[
  {number:"01",title:"Direção",text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Este perfil demonstrativo será substituído por informações oficiais."},
  ...
  {number:"03",title:"Metodologia",text:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent consequat, escuta e prática orientam este exemplo."},
]} />; }
